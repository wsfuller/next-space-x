...
export type GetLaunchesPastQuery = { __typename?: 'Query', launchesPast?: Array<{ __typename?: 'Launch', mission_name?: string | null, launch_date_local?: any | null, rocket?: { __typename?: 'LaunchRocket', rocket_name?: string | null, rocket_type?: string | null } | null } | null> | null };


export const GetLaunchesPastDocument = /*#__PURE__*/ `
  ...
  launchesPast(limit: $limit) {
    ...
    `;
export const useGetLaunchesPastQuery = <
      TData = GetLaunchesPastQuery,
      TError = unknown
    >(
      variables?: GetLaunchesPastQueryVariables,
      options?: UseQueryOptions<GetLaunchesPastQuery, TError, TData>
    ) =>
    useQuery<GetLaunchesPastQuery, TError, TData>(
      variables === undefined ? ['getLaunchesPast'] : ['getLaunchesPast', variables],
      fetcher<GetLaunchesPastQuery, GetLaunchesPastQueryVariables>(GetLaunchesPastDocument, variables),
      options
    );

useGetLaunchesPastQuery.getKey = (variables?: GetLaunchesPastQueryVariables) => variables === undefined ? ['getLaunchesPast'] : ['getLaunchesPast', variables];
;

useGetLaunchesPastQuery.fetcher = (variables?: GetLaunchesPastQueryVariables) => fetcher<GetLaunchesPastQuery, GetLaunchesPastQueryVariables>(GetLaunchesPastDocument, variables);